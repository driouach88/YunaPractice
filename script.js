...
var pool = [];
var ended = false;
var data= {base:10,timeLimit:120,attemptLimit:10};
...
$(document).ready(function(){
	...
	$('#resetAttemptBtn').on('click', function() {
        miniGame.ResetAttempt();
    });
});


miniGame.AddTime = function() {
	document.getElementById('timer').innerHTML = time;
}

miniGame.ResetAttempt = function() {
